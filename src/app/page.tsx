        ...
        <div className="container-custom relative z-10 text-center text-white">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/ploegen" className="btn-primary bg-white text-primary hover:bg-gray-100">
                Ontdek Onze 23 Ploegen
                <ArrowRight className="ml-2 w-4 h-4" />
              </Link>
              <Link href="/clubinfo/sectie?slug=nieuwe-aansluiting" className="btn-secondary border-white text-white hover:bg-white/10">
                Word Lid
              </Link>
            </div>
          </motion.div>
