...
const navItems = [
  ...
  },
  {
    ...
    href: "/clubinfo",
    dropdown: [
      { name: "Missie & Visie", href: "/clubinfo/missie-visie" },
      { name: "Huishoudelijk Reglement", href: "/clubinfo/huishoudelijk-reglement" },
      { name: "API (Integriteit)", href: "/clubinfo/api" },
      { name: "Organigram", href: "/clubinfo/organigram" },
      { name: "Word lid", href: "/word-lid" },
      { name: "Privacyverklaring", href: "/clubinfo/privacyverklaring" },
    ],
  },
